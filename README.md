...
[![codecov](https://codecov.io/gh/danielriddell21/unum/graph/badge.svg)](https://codecov.io/gh/danielriddell21/unum)
...
| `unum image` | Image optimizer — trade quality and scale against file size; static, TUI, and web output |
